  ...
  return (
    <div className="space-y-28 sm:space-y-36">
      <section className="relative min-h-[58vh] lg:min-h-[68vh] flex flex-col justify-center pt-4 lg:pt-8">
        ...
        {home?.tagline && (
          <h1 className="display-xl text-[clamp(2.75rem,10vw,9.5rem)] text-balance rise rise-2 max-w-[18ch]">
            {home.tagline}
          </h1>
        )}

        {home?.intro && (
          <p className="text-xl sm:text-2xl lg:text-[1.65rem] text-[color:var(--color-ink-3)] mt-8 leading-[1.4] max-w-[44rem] rise rise-3">
            {home.intro}
          </p>
        )}
          ...
          <div className="mt-14 rise rise-4">
            ...
            >
              <span className="relative link-reveal">
                {featured.length > 0 ? 'Explore the research' : 'Latest news'}
              </span>
              <span
                aria-hidden
